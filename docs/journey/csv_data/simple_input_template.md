...
**[NODE]** 機械キーで開錠する
- アクション: 機械キーの使用を決定
- ガイド: GUIDE-MECHANICAL-KEY (機械キーの取り出し方と使用方法)
- 次: 機械キー所持確認へ
...
**[NODE]** 機械キー未所持
- 問題: 機械キーを持っていない
- ガイド: GUIDE-MECHANICAL-KEY-LOCATION (機械キーの保管場所)
- 次: ロードサービスへ
...
**[NODE]** 元のキー故障
- 診断: 使用していたキーの故障と判断
- ガイド: GUIDE-KEY-REPAIR (キー修理・交換方法)
- 次: (終了)
...
**[NODE]** ドアロック故障疑い
- 問題: ドアロック機構の故障を疑う
- ガイド: GUIDE-DOOR-LOCK-FAILURE (故障時の対応)
- 次: ロードサービスへ
